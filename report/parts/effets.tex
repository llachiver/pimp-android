...
\subsection{Convolution (Blur, Sharpen, Neon) :} \label{convolution}
    ...
    \subsubsection{Détection des contours (Néon) : } \label{neon}
        ...
        Les valeurs résultantes de la convolution en "Neon" ne sont pas normalisées par extension linéaire, elles sont justes tronquées entre [0 - 255], pour avoir un résultat plus fidèle, il faudrait passer par une image intermédiaire, calculer 
