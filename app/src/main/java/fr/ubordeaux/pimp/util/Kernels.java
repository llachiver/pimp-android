...
public class Kernels {
     ...
     *
     * @param width  Required width of the matrix
     * @param height Required height of the matrix
     * @return Matrix in a 1D array of size width*height
     */
    ...
    /**
     * Generates a 2D kernel using the Laplacian Of Gaussiian formula @Link https://homepages.inf.ed.ac.uk/rbf/HIPR2/log.html
     *
     * @param size Dimension of the kernel
     * @return The kernel in a 1D float array with a length of size*size
     */
